          ...
          <div className="flex h-28 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                <button className="relative text-gray-700 hover:text-yellow-800 font-medium transition-all duration-300 py-2 flex items-center gap-1">
                  Services
                  ...
                  <div className="py-2">
                    {[
                      ...
                      <Link
                        key={service.name}
                        href={service.href}
                        className="block px-4 py-2 text-gray-700 hover:text-yellow-800 hover:bg-yellow-50 transition-all duration-200 transform hover:translate-x-1"
