...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden page-blue">
      {/* Header */}
      <header className="border-b bg-white sticky top-0 z-50 transition-all duration-300">
          ...
          <div className="flex h-28 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                <button className="relative text-gray-700 hover:text-blue-600 font-medium transition-all duration-300 py-2 flex items-center gap-1">
                  Services
                  ...
                  <div className="py-2">
                    {[
                      ...
                      <Link
                        key={service.name}
                        href={service.href}
                        className="block px-4 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200 transform hover:translate-x-1"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="stats-grid grid grid-cols-2 gap-8 pt-8">
                {[
                  { number: '200+', label: 'Technical Projects', delay: '0ms' },
                  { number: '50+', label: 'Research Papers', delay: '200ms' }
                ].map((stat, index) => (
