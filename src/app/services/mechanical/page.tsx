...
import { Cog, Wrench, Hammer, Thermometer, Gauge, Settings2, ChevronRight, Clock, Globe, Phone, Mail, Star, MapPin } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mt-8">
            {[
              ...
              { icon: Cog, text: 'Engineered Precision' },
