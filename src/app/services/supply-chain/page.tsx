...
import { Globe, Package, Clipboard, TrendingUp, Calendar, Truck, ChevronRight, Clock, Phone, Mail, Star, MapPin } from 'lucide-react'
    ...
    >
      ...
      <section className="py-20 bg-gradient-to-br from-amber-700 via-orange-700 to-amber-800 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <p className="text-xl text-amber-100 max-w-4xl mx-auto leading-relaxed">We secure parts, manage logistics, and maintain quality so your teams can focus on delivery.</p>
