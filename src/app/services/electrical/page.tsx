			...
			<section className="py-16 bg-white">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
						{[
							{ icon: ChevronRight, title: 'Turnkey EPC Projects', desc: 'End‑to‑end design, procurement, construction, testing, and handover.' },
							{ icon: ChevronRight, title: 'Transmission Lines', desc: 'Route engineering, stringing, sag‑tension, hardware selection, and QA.' },
							{ icon: ChevronRight, title: 'Grid Stations & Substations', desc: 'Primary/secondary design, protection & control, SCADA/telemetry.' },
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
						{[
							...
							{ src: '/images/electrical/relay-panel.jpg', alt: 'Protection Relay Panel' },
							{ src: '/images/electrical/grid-equipment.jpg', alt: 'Grid Equipment Delivery' },
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
					...
					<div className="grid sm:grid-cols-3 gap-6 mt-8">
						{[
							...
							{ icon: ChevronRight, text: 'Rapid Response Team' },
